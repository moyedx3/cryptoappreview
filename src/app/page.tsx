...
const ReviewCard = ({
  ...
  <article className="bg-white border-4 border-black flex flex-col brutalist-shadow-hover transition-all duration-200">
    ...
    <div className="p-4 flex flex-col flex-grow">
      ...
      <h3
        className="font-display text-2xl uppercase leading-none mb-1"
...
const LovedAppItem = ({
  ...
  <li className="flex items-start gap-3 group cursor-pointer">
    ...
    <div>
      <h4 className="font-bold text-sm uppercase leading-tight group-hover:underline">
        {name}
      </h4>
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0 flex items-center gap-2">
            <img
              src="/images/logo.svg"
              alt="Crypto App Review Logo"
              className="w-10 h-10"
            />
            <span
              className="font-display text-3xl uppercase tracking-wider hidden sm:block"
              style={customStyles.heading}
            >
              CRYPTO APP REVIEW
            </span>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              href="/"
              className="font-bold hover:underline hover:bg-[#D1FAE5] px-2 py-1 transition-colors text-sm uppercase tracking-widest"
            >
              Review
            </Link>
            <a
          ...
          <div className="lg:hidden">
            <button
              ...
              className="p-2 border-2 border-black bg-[#D1FAE5]"
            >
              <svg
                className="w-6 h-6"
                fill="none"
  ...
  <footer className="bg-black text-[#D1FAE5] mt-12 py-12 border-t-4 border-black">
    <div className="max-w-[1440px] mx-auto px-4 md:px-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        <div>
          <span
            className="font-display text-4xl uppercase tracking-wider mb-4 block"
            style={customStyles.heading}
          >
            Crypto App Review
          </span>
          <p className="text-white text-sm max-w-xs">
            The internet&apos;s laziest crypto nerd. Reviews, scouts and
            analysis from the world of crypto.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-white uppercase mb-4 text-lg">
            Sections
          </h4>
...
export default function HomePage() {
  ...
  const lovedApps = [
    { rating: 10, name: "Phantom", category: "Solana Wallet" },
    { rating: 9, name: "Aave", category: "Lending Protocol" },
    { rating: 9, name: "Jupiter", category: "Aggregator" },
    { rating: 8, name: "Rabby", category: "Browser Wallet" },
    { rating: 8, name: "Curve", category: "Stable Swap" },
  ];
          ...
          <div className="lg:col-span-8 flex flex-col gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="aspect-square w-full h-full bg-gray-200 border-b-4 md:border-b-0 md:border-r-4 border-black relative flex items-center justify-center overflow-hidden">
                    <div className="w-full h-full bg-neutral-800 flex items-center justify-center">
                      <svg
                        className="w-32 h-32 text-[#D1FAE5]"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
                  ...
                  <div className="p-6 md:p-8 flex flex-col justify-between h-full bg-white">
                    <div>
                      <div className="mb-2">
                        ...
                        <h1
                          className="font-display text-4xl md:text-5xl uppercase leading-none mb-2"
                          style={customStyles.heading}
                        >
                          Coinbase
                        </h1>
                        <h2
                          className="font-display text-2xl md:text-3xl uppercase text-gray-500 leading-none mb-4"
                          style={customStyles.heading}
                        >
                          Advanced Trade
                        </h2>
                      ...
                      <p className="font-sans text-lg leading-relaxed font-medium mb-6">
                        The industry leader remains the gold standard for UI,
                        but are the fees finally becoming too steep for the
                        retail investor? We dive into the new liquidity pools.
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div className="flex flex-col">
                        ...
                        <span
                          className="font-display text-4xl text-black bg-[#D1FAE5] px-2 py-1 inline-block -skew-x-6 border-2 border-black shadow-[4px_4px_0px_0px_#888]"
                          style={customStyles.heading}
                        >
                          8/10
                        </span>
            ...
            <section>
              <div className="flex items-center justify-between mb-6 border-b-4 border-black pb-2">
                ...
                <a href="#" className="font-bold underline hover:bg-white px-1">
                  View All
                </a>
              </div>
          ...
          <aside className="lg:col-span-4 space-y-12">
            <div className="bg-white border-4 border-black p-6 brutalist-shadow">
              ...
              <ul className="space-y-4">
                {lovedApps.map((app, index) => (
                  <LovedAppItem key={index} {...app} />
                ))}
              </ul>
              <a
                href="#"
                className="block mt-6 text-center text-xs font-bold uppercase tracking-widest border-2 border-black py-2 hover:bg-black hover:text-white transition-colors"
              >
            ...
            <div className="bg-black text-[#D1FAE5] p-6 brutalist-shadow border-4 border-black">
              ...
              <p className="font-medium mb-4 text-white text-sm">
                Get the latest crypto app reviews and DeFi alpha delivered to
                your inbox.
              </p>
              <form className="space-y-3" onSubmit={handleSubscribe}>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#D1FAE5] text-black font-display text-xl uppercase py-2 border-4 border-[#D1FAE5] hover:bg-white hover:border-white transition-colors"
                  style={customStyles.heading}
                >
                  Join List
                </button>
            ...
            <div className="bg-[#D1FAE5] border-4 border-black p-6 brutalist-shadow">
              ...
              <p className="font-bold text-sm mb-4">
                Help keep the reviews objective by supporting our independent
                research.
              </p>
            ...
            <div className="bg-white border-4 border-black p-6 brutalist-shadow">
              <h3
                className="font-display text-2xl uppercase mb-4 border-b-4 border-black pb-2"
                style={customStyles.heading}
              >
                Categories
              </h3>
              <div className="flex flex-wrap gap-2">
                <a
                  href="#"
                  className="px-2 py-1 border-2 border-black text-xs font-bold uppercase hover:bg-black hover:text-white transition-colors"
                >
                  DeFi
                </a>
                <a
