...
export default function NewArticle() {
  ...
  return (
    <div>
      <h1 className="font-display text-4xl uppercase mb-8">New Article</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              placeholder="Full review content (supports markdown)..."
            />
          </div>
          ...
          <div className="flex gap-6">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="w-5 h-5 border-4 border-black"
              />
              <span className="font-bold uppercase">Publish Now</span>
            </label>
          </div>
        </div>
